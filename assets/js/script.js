...
const criptografar = () => {
    ...
    containerResultado.innerHTML = '<textarea name="" id="texto_resultado" readonly cols="20" rows="20">' + textCriptografado + '</textarea>'
}
...
const descriptografar = () => {
    ...
    containerResultado.innerHTML = ''
    containerResultado.innerHTML = '<textarea name="" id="texto_resultado" readonly cols="20" rows="20">' + textDescriptografado + '</textarea>'
}
