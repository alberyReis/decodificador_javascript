...
const criptografar = () => {
    ...
    containerResultado.innerHTML = '<textarea name="" id="texto_resultado" readonly cols="25" rows="30">' + textCriptografado + '</textarea>'
}
...
const descriptografar = () => {
    ...
    containerResultado.innerHTML = ''
    containerResultado.innerHTML = '<textarea name="" id="texto_resultado" readonly cols="25" rows="30">' + textDescriptografado + '</textarea>'
}
